...
function optionChanged(selectedID){
   ...
   //  console.log(data);
    ...
    d3.select("#selDataset").style('background', 'f3d5b5').node().value = selectedID;
    ...
    const panelDisplay = d3.select("#sample-metadata").style('color', 'gray').style('font-weight' , 'light').style('background', '#edf2fb');
    panelDisplay.html("");
 ...
 const guageData = [
    {
      ...
      mode: "gauge+number",     
       ...
       bar: { color: "#E4EDF2" },
       steps: [
          { range: [0, 1], color: "#a9d6e5" },
          { range: [1, 2], color: "#89c2d9" },
          { range: [2, 3], color: "#61a5c2" },
          { range: [3, 4], color: "#468faf" },
          { range: [4, 5], color: "#2c7da0" },
          { range: [5, 6], color: "#2a6f97" },
          { range: [6, 7], color: "#415a77" },
          { range: [7, 8], color: "#354f52" },
          { range: [8, 9], color: "#333533" }
